        ...
        <div className="rounded-[38px] bg-[#EEF0F2] flex flex-col md:flex-row overflow-hidden min-h-[600px]">
          ...
          <div className="flex-1 flex items-center justify-center px-8 md:px-14 py-12">
            <div className="w-full max-w-[400px]">
              ...
              <h1 className="text-4xl font-bold text-[#1A1A2E] mb-1">Hello again!</h1>
              <p className="text-sm font-semibold text-[#8B7CFF] mb-8">
                Welcome back to VoxSign
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="text-right">
                  <Link
                    ...
                    className="text-sm font-medium text-[#8B7CFF] hover:text-[#5B4FD6] transition-colors"
                  >
                    Recovery password
                  </Link>
                </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-[#6B7280]">
                  ...
                  <Link href="/signup" className="font-semibold text-[#8B7CFF] hover:text-[#5B4FD6] transition-colors">
                    Sign up
                  </Link>
                </p>
              </div>
